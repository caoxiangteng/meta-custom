...
int reset_imx6ull(void)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RESET_IMX6ULL_GPIO failed\n");
        return -1;
    }
...
int reset_zigbee(void)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RESET_ZIGBEE_GPIO failed\n");
        return -1;
    }
...
int reset_rgm(void)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RESET_RGM_GPIO failed\n");
        return -1;
    }
...
int enable_buttom(void)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RBUTTOM_CONTROL_GPIO, failed\n");
        return -1;
    }
...
int led_red_control(int value)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RLED_R_GPIO, failed\n");
        return -1;
    }
...
int led_green_control(int value)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RLED_G_GPIO, failed\n");
        return -1;
    }
...
int led_blue_control(int value)
{
    ...
    if (ret < 0) {
        printf("--cxt--get RLED_B_GPIO, failed\n");
        return -1;
    }
